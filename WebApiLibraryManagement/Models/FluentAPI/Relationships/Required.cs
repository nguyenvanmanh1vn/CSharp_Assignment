...
namespace WebApiLibraryManagement.Models.FluentAPI.Relationships.Required
{
    public class MyContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BorrowingRequest>().HasData(
                new { Id = 1, UserId = 1, Status = Status.Approving, CreatedDate = DateTime.Now},
                new { Id = 2, UserId = 1, Status = Status.Approving, CreatedDate = DateTime.Now},
                new { Id = 3, UserId = 2, Status = Status.Pending, CreatedDate = DateTime.Now},
                new { Id = 4, UserId = 3, Status = Status.Rejecting, CreatedDate = DateTime.Now},
                new { Id = 5, UserId = 4, Status = Status.Approving, CreatedDate = DateTime.Now}
            );
            ...
            modelBuilder.Entity<User>().HasData(
                new { Id = 1, UserName = "Manh", Password = "123456", FirstName = "Manh", LastName = "Nguyen", Gender = Gender.Male, Phone = "0123456789", Email = "manh@gmail.com", RoleId = 1, CreatedDate = DateTime.Now},
                new { Id = 2, UserName = "Tung", Password = "123456", FirstName = "Tung", LastName = "Tran", Gender = Gender.Male, Phone = "9876543210", Email = "tung@gmail.com", RoleId = 2, CreatedDate = DateTime.Now},
                new { Id = 3, UserName = "Trang", Password = "123456", FirstName = "Trang", LastName = "Bui", Gender = Gender.Female, Phone = "1237894560", Email = "trang@gmail.com", RoleId = 2, CreatedDate = DateTime.Now},
                new { Id = 4, UserName = "Thu", Password = "123456", FirstName = "Thu", LastName = "Nguyen", Gender = Gender.Female, Phone = "4561237890", Email = "thu@gmail.com", RoleId = 2, CreatedDate = DateTime.Now},
                new { Id = 5, UserName = "Hung", Password = "123456", FirstName = "Hung", LastName = "Nguyen", Gender = Gender.Male, Phone = "7894561230", Email = "hung@gmail.com", RoleId = 2, CreatedDate = DateTime.Now},
                new { Id = 6, UserName = "Toan", Password = "123456", FirstName = "Toan", LastName = "Tran", Gender = Gender.Male, Phone = "7891234560", Email = "toan@gmail.com", RoleId = 2, CreatedDate = DateTime.Now}
            );
        }
        #endregion
    }
